-- Comprehensive Product Data Enhancement - FINAL VERSION
-- Handles existing data properly with DELETE statements first
-- Adds realistic, product-specific data across all dimensions

-- ============================================
-- CLEANUP: Remove existing comprehensive data
-- ============================================
-- This ensures no conflicts with existing records

-- Delete existing additional data for these products
-- (Keep the products and basic metrics)
...
DELETE FROM public.product_partners
WHERE product_id IN (
    '11111111-1111-1111-1111-111111111111',
    '22222222-2222-2222-2222-222222222222',
    '33333333-3333-3333-3333-333333333333',
...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'SOC2', 'complete', '2024-09-01', '2025-09-01', 'Type II certification'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'GDPR', 'complete', '2024-05-01', NULL, 'Global compliance'),

-- Fraud Detection AI
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'SOC2', 'complete', '2024-11-15', '2025-11-15', 'Type II certification'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'GDPR', 'complete', '2024-08-15', NULL, 'Global compliance'),

-- Finicity
('10101010-1010-1010-1010-101010101010', 'SOC2', 'complete', '2024-07-01', '2025-07-01', 'Type II certification'),
