...
class CogneeClient:
    ...
    async def initialize(self):
        ...
        os.environ["LLM_MODEL"] = (
            "groq/llama-3.3-70b-versatile"  # Updated to current production model
        )
    ...
    async def query(
        ...
        search_results = await cognee.search(query_text=query_text, query_type=SearchType.INSIGHTS)
