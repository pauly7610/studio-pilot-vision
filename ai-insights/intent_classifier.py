...
class IntentClassifier:
    ...
    FACTUAL_KEYWORDS = [
        ...
        "currently", "at present", "right now"
    ]
    
    MIXED_KEYWORDS = [
        "compare", "versus", "vs", "difference between",
        "how does", "similar to", "different from",
    ...
    def _heuristic_classify(self, query_lower: str) -> Tuple[QueryIntent, float, str]:
        ...
        if intent_types_matched > 1 or mixed_score > 0:
            ...
            return QueryIntent.MIXED, confidence, f"Multiple intent signals: H={historical_score}, C={causal_score}, F={factual_score}"
...
Example: HISTORICAL|0.85|Query asks about past event"""
    ...
    def get_classification_stats(self) -> Dict[str, any]:
        ...
        return {
            ...
            "llm_fallback_rate": sum(1 for c in self.classification_history if "LLM:" in c["reasoning"]) / len(self.classification_history)
        }
